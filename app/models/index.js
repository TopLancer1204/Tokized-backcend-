...
db.Howworks = require('../models/howworks.model.js')(sequelize, Sequelize)
...
// db.affcommission.belongsTo(db.users, {
//   foreignKey: 'userId',
//   sourceKey: 'id'
// });
...
db.user.hasMany(db.coupon, { foreignKey:'userId', sourceKey: 'id'});
